...
#SBATCH --gres=gpu:1                 # Number of GPUs per node (Ensure GPU has enough VRAM, e.g., >40GB, ideally 80GB)
#SBATCH --mem=64G                   # Job memory request (Increased significantly for 17B model)
...
singularity exec --nv --overlay container/overlay.img container/container_llm.sif python3 news_generation_S.py
